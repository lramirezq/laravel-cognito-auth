...
class CognitoClient
{
    ...
    public function __construct(
        ...
        $this->poolId       = env('AWS_COGNITO_USER_POOL_ID');
    }
    ...
    {
        Log::info("veamos si tenemos los valores ClientID : ".$this->clientId );
        Log::info("veamos si tenemos los valores PoolID : ".$this->poolId );
